...
under its exchangeability assumptions. The paper's main contribution is the
operational analysis: asymmetric costs, review capacity, reviewer error, and
dataset-specific break-even thresholds.

## Overall Benchmark Summary (`results_v2`)
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| `cost_controlled_mondrian` | **98.8%** | **97.7%** | 1.71 | 71.9% | **0.0212** |
| `mondrian_cp` | **91.8%** | **92.2%** | 1.36 | 38.3% | **0.1435** |
| `class_weighted_threshold` | 77.9% | 80.3% | 1.00 | 0.0% | 0.3402 |
| `cost_tuned_threshold` | 77.9% | 80.0% | 1.00 | 0.0% | 0.3404 |
| `aps_cp` | 90.2% | 55.6% | 1.09 | 19.8% | 0.3800 |
| `raps_cp` | 90.2% | 48.7% | 1.07 | 15.7% | 0.4445 |
| `marginal_cp` | 91.1% | **30.5%** | 1.04 | 12.5% | 0.4129 |
| `class_conditional_rejector` | 94.9% | 47.2% | 1.13 | 13.2% | 0.4207 |
| `risk_controlled_rejector` | 93.6% | 44.6% | 1.08 | 8.0% | 0.4946 |
| `capacity_limited_mondrian` | 88.2% | 73.5% | 1.06 | 8.5% | 0.4106 |
| `confidence_rejector` | 99.2% | 98.0% | 1.81 | 80.9% | 0.0190 |
...
## Full Benchmark Grid (KBS / Journal Submission)
...
Resume works automatically from `results_v2/checkpoints`. Do not pass
...
pip install -e .
python scripts/run_benchmark.py \
  --model hgb --output-dir results_v2
pytest -q
```
...
@article{singh2026cost,
  title={Cost-Sensitive Conformal Prediction for Imbalanced High-Stakes Decisions},
  author={Singh, Manpreet and Srikantha, Akshatha},
...
**APA Format:**
> Singh, M., & Srikantha, A. (2026). Cost-Sensitive Conformal Prediction for Imbalanced High-Stakes Decisions. *Knowledge-Based Systems* (Under Review).
