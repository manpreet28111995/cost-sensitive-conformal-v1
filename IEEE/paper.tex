...
\caption{Average rank of decision methods by expected decision cost ($\mathbb{E}[L]$, $C_{\mathrm{rev}}=0.50$) over $N=15$ datasets. Lower is better.}
\label{fig:cd_cost}
\end{figure*}
...
\begin{itemize}
    \item \textbf{Code and Data Availability}: All code, benchmark scripts, and data pre-processing pipelines supporting this study are published on GitHub at \url{https://github.com/manpreet28111995/cost-sensitive-conformal-v1}. All 15 benchmark datasets are retrieved programmatically from OpenML by dataset identifier; no proprietary data are used.
    ...
    \textit{\textbf{Deepak Parashar:}} Formal analysis, Methodology, Writing -- review and editing. \\
    \textit{\textbf{Rahul Joshi:}} Supervision, Formal analysis, Visualization, Writing -- review and editing.
\end{itemize}
